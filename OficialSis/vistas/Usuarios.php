        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- --------------------------------------------------------------------------------------------------------------------------------------------- -->
                ...
                <div class="table-responsive">
                        <table class="table table-bordered" width="100%" cellspacing="0" id="dataTableUsuario">
                            <thead>
                                <th>Id Usuario</th>
                                <th>Usuario</th>
                                <th>Contraseña</th>
    ...
    function  MostrarDatos()
    {
        $.ajax({
                ...
                success:function(data){
                    ...
                    $('#dataTableUsuario tbody').html(tr);
